	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item active"><a href="adminpost.jsp" class="nav-link">Posts</a></li>
    ...
    <!-- END nav -->
    	...
    	<div class="container">
          ...
          <div class="col-md-7 text-center heading-section ftco-animate">
            <h2 class="mb-1">Magazines</h2><br><br>
			<center><table border="2">
			<tr>
			<th><center><p style="margin-top: 16px;margin-left: 20px;margin-right: 20px;">Magazine Name</p></center></th>
			<th><center><p style="margin-top: 16px;margin-left: 20px;margin-right: 20px;">Description</p></center></th>
			<th><center><p style="margin-top: 16px;margin-left: 20px;margin-right: 20px;">ID No.</p></center></th>
			<th><center><p style="margin-top: 16px;margin-left: 20px;margin-right: 20px;">Ranking</p></center></th>
			<th><center><p style="margin-top: 16px;margin-left: 20px;margin-right: 20px;">Action</p></center></th>
			</tr>
			<%@include file="dbcon.jsp"%>
			<%
			Statement st = con.createStatement();
			ResultSet rs = st.executeQuery(" select * from magazine where status = 'yes' and cnt >= 3 ");
			while(rs.next()){%>
			<tr>
			...
			<td><center><p style="margin-top: 16px;margin-left: 20px;margin-right: 20px;"><%=rs.getString(8)%></p></center></td>
			<td><center><p style="margin-top: 16px;margin-left: 20px;margin-right: 20px;"><a href="Magazine/<%=rs.getString("mfile")%>" target="_blank">View</a></p></center></td>
			</tr>
			<%}%>
