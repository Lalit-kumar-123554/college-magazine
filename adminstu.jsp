	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item active"><a href="adminstu.jsp" class="nav-link">Students</a></li>
    ...
    <!-- END nav -->
    	...
    	<div class="container">
          ...
          <div class="col-md-7 text-center heading-section ftco-animate">
            <h2 class="mb-1">Students</h2><br><br>
			<center><table border="2">
			<tr>
			<th><center><p style="margin-top: 16px;margin-left: 20px;margin-right: 20px;">Name</p></center></th>
			<th><center><p style="margin-top: 16px;margin-left: 20px;margin-right: 20px;">Branch</p></center></th>
			<th><center><p style="margin-top: 16px;margin-left: 20px;margin-right: 20px;">Section</p></center></th>
			<th><center><p style="margin-top: 16px;margin-left: 20px;margin-right: 20px;">Year</p></center></th>
