	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item"><a href="editposts.jsp" class="nav-link">Rank Posts</a></li>
	          <li class="nav-item active"><a href="approvedposts.jsp" class="nav-link">Approved</a></li>
    ...
    <!-- END nav -->
    	...
    	<div class="container">
          ...
          <div class="col-md-7 text-center heading-section ftco-animate">
            <h2 class="mb-1">Approved Magazines</h2><br><br>
			<center><table border="2">
			<tr>
			<th><center><p style="margin-top: 16px;margin-left: 20px;margin-right: 20px;">Magazine Name</p></center></th>
			<th><center><p style="margin-top: 16px;margin-left: 20px;margin-right: 20px;">Date of Approval</p></center></th>
			...
			ResultSet rs = st.executeQuery(" select * from appmag where eid='"+eid+"' ");
			while(rs.next()){%>
			<tr>
			...
			<td><center><p style="margin-top: 16px;margin-left: 20px;margin-right: 20px;"><%=rs.getString(7)%></p></center></td>
			</tr>
			<%}%>
