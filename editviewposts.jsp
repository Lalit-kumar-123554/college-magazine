	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item active"><a href="editviewposts.jsp" class="nav-link">All Posts</a></li>
    ...
    <!-- END nav -->
    	...
    	<div class="container">
          ...
          <div class="col-md-7 text-center heading-section ftco-animate">
			...
			<td><center><p style="margin-top: 16px;margin-left: 20px;margin-right: 20px;"><a href="Magazine/<%=rs.getString("mfile")%>" target="_blank">View</a>
			</tr>
			<%}%>
