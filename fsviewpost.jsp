	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item"><a href="fsupload.jsp" class="nav-link">Upload Posts</a></li>
	          <li class="nav-item active"><a href="fsviewpost.jsp" class="nav-link">View Posts</a></li>
    ...
    <!-- END nav -->
    	...
    	<div class="container">
          ...
          <div class="col-md-7 text-center heading-section ftco-animate">
			...
			<td><center><p style="margin-top: 16px;margin-left: 20px;margin-right: 20px;"><a href="download.jsp?id=<%=rs.getString(4)%>">Download</a></p></center></td>
			</tr>
			<%}%>
